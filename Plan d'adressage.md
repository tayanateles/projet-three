...
R2 | Gi0/1 | connected to R1 on port Gi0/2 | **10.1.1.1** | fe80::2:cafe:4
R2 | Gi0/2 | connected to DS1 on port Gi2/0 | **10.2.1.2** | fe80::2:cafe:4
R2 | Gi0/3 | connected to R3 on port Gi0/2 | **10.1.3.1**| fe80::2:cafe:4
R2 | Gi0/4 | connected to DS1 on port Gi3/0 | **10.2.2.2** | fe80::2:cafe:4
R2 | Gi0/5 | connected to DS2 on port Gi2/1 | **10.2.3.2** | fe80::2:cafe:4
R2 | Gi0/6 | connected to DS2 on port Gi3/1 | **10.2.4.2** | fe80::2:cafe:4
...
R3 | Gi0/1 | connected to R1 on port Gi0/3 | **10.1.2.1** | fe80::3:cafe:4
R3 | Gi0/2 | connected to R2 on port Gi0/3 | **10.1.3.1** | fe80::3:cafe:4
R3 | Gi0/3 | connected to DS2 on port Gi2/0 | **10.3.1.3** | fe80:3::cafe:4
R3 | Gi0/4 | connected to DS2 on port Gi3/0 | **10.3.2.3** | fe80::3:cafe:4
R3 | Gi0/5 | connected to DS1 on port Gi2/1 | **10.3.3.3** | fe80::3:cafe:4
R3 | Gi0/6 | connected to DS1 on port Gi3/1 | **10.3.4.3** | fe80::3:cafe:4
